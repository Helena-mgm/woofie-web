...
4. 🤖  Download the **ollama** AI model for WoofieBot *(may take 2–5 min on first run)*
...
> The configured **llama3.2:3b** model is lightweight. Make sure you have enough disk space and a stable connection.
...
4. 🤖  Télécharger le modèle d'IA **llama3.2:3b** pour WoofieBot *(peut prendre 2-5 min à la première fois)*
...
make ollama-pull
```
> Le modèle configuré **llama3.2:3b** est léger. Assurez-vous d'avoir suffisamment d'espace disque et une bonne connexion.
